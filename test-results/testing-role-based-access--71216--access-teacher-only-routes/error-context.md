...
- Name: Role-Based Access Control Tests >> Student should not access teacher-only routes
- Location: C:\Users\kingo\OneDrive\Documents\learnbridge-edu\testing\role-based-access.spec.js:47:3
...
Call log:
  - waiting for locator('#firstName')
    ...
    at C:\Users\kingo\OneDrive\Documents\learnbridge-edu\testing\role-based-access.spec.js:50:16
```

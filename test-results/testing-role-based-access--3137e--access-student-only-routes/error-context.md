...
- Name: Role-Based Access Control Tests >> Student should access student-only routes
- Location: C:\Users\kingo\OneDrive\Documents\learnbridge-edu\testing\role-based-access.spec.js:85:3
...
Call log:
  - waiting for locator('#firstName')
    ...
    at C:\Users\kingo\OneDrive\Documents\learnbridge-edu\testing\role-based-access.spec.js:88:16
```

...
- Name: Role Validation Tests >> Empty role selection should show error
- Location: C:\Users\kingo\OneDrive\Documents\learnbridge-edu\testing\role-validation.spec.js:21:3
...
Call log:
  - navigating to "http://localhost:3000/sign-up", waiting until "load"
    ...
    at C:\Users\kingo\OneDrive\Documents\learnbridge-edu\testing\role-validation.spec.js:23:16
```
